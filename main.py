from manager import \
    ...
    receive_twin_reported,aioconsole, \
    clear_desired_twin,process_production,\
    asyncio, os,load_dotenv,get_most_recent_blob, receive_device_ids, \
    BlobServiceClient, run_res_error, process_error_dm, datetime, send_device_connection_keys
import sys
...
async def main():
    ...
    try:
        ...
        print(f"error when sending a message to the 2Q")
    ...
    try:
        while True:      
            for device in productionLine:  
                ...
                twin_reported_dir.append(twin_reported)
            ...
            try:
                ...
                if new_data1:
                    await process_production(registry_manager, twin_reported_dir, new_data1)
